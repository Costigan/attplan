...
namespace attplan.Viz
{
    public class TrajectoryShape : Shape
    {
        ...
        */
        ...
        public static long StartTimestamp = MainWindow.FirstTimestamp;
        public static long StopTimestamp = MainWindow.LastTimestamp;
...
/*                if (false)
            ...
            for (int i = 0; i < Length; i++)
            {
                ...
                Vectors[i].X = (float) p.X/MainWindow.FarUnit;
                Vectors[i].Y = (float) p.Y/ MainWindow.FarUnit;
                Vectors[i].Z = (float) p.Z/ MainWindow.FarUnit;
            }
