...
namespace attplan.util
{
    ...
    public static class TimeUtilities
    {
        ...
        public static string Time42ToITOS(long time42)
        {
            ...
            string result = dt.ToString("yy-") + dt.DayOfYear.ToString("000");
        ...
        {
            DateTime dt = Time40ToDateTime(time40);
            string result = dt.ToString("yy-") + dt.DayOfYear.ToString("000");
            result = result + dt.ToString("-HH:mm:ss.") + dt.Millisecond.ToString("000");
            return result;
        }
        ...
        {
            DateTime dt = Time42ToDateTime(time40);
            dt = dt.AddSeconds(-3);
            return dt.ToString("dd MMM yyyy HH:mm:ss.fff");
        }
        ...
        public static DateTime? ParseDOYTime(string text)
        {
            try
            {
                ...
                Match match = DOYDateRecognizer.Match(text);
