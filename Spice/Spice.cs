...
namespace attplan.spice
{
    public class CSpice
    {
        ...
        [DllImport("cspice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void et2utc_c(double et,
        ...
        /// </summary>
        /// <param name="a">Length of the ellisoid semi-axis along the x-axis.</param>
        /// <param name="b">Length of the ellisoid semi-axis along the y-axis. </param>
        /// <param name="c">Length of the ellisoid semi-axis along the z-axis.</param>
        /// <param name="point">Body-fixed coordinates of a point on the ellipsoid </param>
        /// <param name="normal">Outward pointing unit normal to ellipsoid at point</param>
        [DllImport("cspice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void surfnm_c(double a,
                double b,
                double c,
                double[] point,
                double[] normal);
        ...
        /// </summary>
        /// <param name="point">Position of a point in bodyfixed frame</param>
        /// <param name="a">Length of semi-axis parallel to x-axis</param>
        /// <param name="b">Length of semi-axis parallel to y-axis</param>
        /// <param name="c">Length on semi-axis parallel to z-axis</param>
        /// <param name="pnear">Point on the ellipsoid closest to positn</param>
        /// <param name="dist">Altitude of positn above the ellipsoid</param>
        [DllImport("cspice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void nearpt_c(double[] point,
                                           double a,
                                           double b,
                                           double c,
                                           double[] pnear,
        ...
        /// <param name="a">Length of the ellipsoid semi-axis along the x-axis.</param>
        /// <param name="b">Length of the ellipsoid semi-axis along the y-axis.</param>
        /// <param name="c">Length of the ellipsoid semi-axis along the z-axis.</param>
        /// <param name="point">Point on the ellipsoid pointed to by u.</param>
        /// <param name="found">Flag indicating if u points at the ellipsoid.</param>
        [DllImport("cspice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void surfpt_c(double[] positn,
            double[] u,
            double a,
        ...
        /// <param name="clkstr">
        ///     is an input argument when op is "SET."  It takes the
        ...
        /// </summary>
        /// <param name="op">
        ///     indicates the operation -- "GET" or "SET".  "GET" means,
        ...
        /// </param>
        /// <param name="level">
        ///     is the level (granularity) at which the coverage
        ...
        /// </param>
        /// <param name="tol">
        ///     is a tolerance value expressed in ticks of the
        ...
        /// </param>
        /// <param name="timsys">
        ///     is a string indicating the time system used in the
        ...
        /// </param>
        /// <param name="cell">
        ///     is an initialized CSPICE window data structure.
        ...
        /// <param name="elts">
        ///     Equivalent conic elements (array of 8)
        ...
        /// 
        /// </summary>
        /// <param name="bodynm"></param>
        /// <param name="item"></param>
        /// <param name="maxn"></param>
        /// <param name="dim"></param>
        /// <param name="values"></param>
        [DllImport("cspice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern void bodvrd_c([MarshalAs(UnmanagedType.LPStr)] string bodynm,
                                           [MarshalAs(UnmanagedType.LPStr)] string item,
                                           int maxn,
            ref int dim,
            double[] values);
        ...
        {
            double et = TimeUtilities.Time42ToET(time);
        ...
        {
            // Convert epoch to ephemeris time
            double et = TimeUtilities.Time42ToET(time42);
            double lt = 0d;

            double[,] xform = GetMoonFixedToMoonSolarTransform(et);
        ...
        public void GetEastGrazingPoint(long time42, out double grazeLongitude, out double grazeLattitude,
                                        out double grazeAltitude,
                                        out double solarLongitude, out double solarLattitude)
        {
            ...
            GetGrazingPointInner(time42, ladeeState, grazeVector, out grazeLongitude, out grazeLattitude,
                                 out grazeAltitude,
                                         ...
                                         out double solarLattitude)
        {
            ...
            double ang1 = vdot_c(grazeVector, vecGrz1);
            double ang2 = vdot_c(grazeVector, vecGrz2);

            double[] pnt = ang1 > ang2 ? grz1 : grz2;
        ...
        public void GetWestGrazingPoint(long time42, out double grazeLongitude, out double grazeLattitude,
                                        out double grazeAltitude, out double solarLongitude, out double solarLattitude)
        {
            var ladeeState = new double[6];
            double et = TimeUtilities.Time42ToET(time42);
            double lt = 0d;
            ...
            GetGrazingPointInner(time42, ladeeState, grazeVector, out grazeLongitude, out grazeLattitude,
                                 out grazeAltitude, out solarLongitude, out solarLattitude);
        }

        public void GetNorthGrazingPoint(long time42, out double grazeLongitude, out double grazeLattitude,
                                         out double grazeAltitude, out double solarLongitude, out double solarLattitude)
        {
            var ladeeState = new double[6];
            double et = TimeUtilities.Time42ToET(time42);
            ...
            // The LADEE's state in ME frame
            spkgeo_c(-12, et, "MOON_ME", 301, ladeeState, ref lt);
            double[] grazeVector = ZAxis;
            GetGrazingPointInner(time42, ladeeState, grazeVector, out grazeLongitude, out grazeLattitude,
                                 out grazeAltitude, out solarLongitude, out solarLattitude);
        }

        public void GetSouthGrazingPoint(long time42, out double grazeLongitude, out double grazeLattitude,
                                         out double grazeAltitude,
                                         out double solarLongitude, out double solarLattitude)
        {
            var ladeeState = new double[6];
        ...
        public static unsafe bool CkGetCoverage(string filename, out long start, out long stop)
        {
            ...
            const int spiceDp = 1;
            const int spiceCellCtrlsz = 6;
            const int maxiv = 100000;
            const int winsiz = (2*maxiv);

            //size=WINSIZ

            var spiceCellName = new double[spiceCellCtrlsz + winsiz];
            ...
            fixed (double* p1 = spiceCellName)
            {
                name.ptr1 = p1;
                name.ptr2 = p1 + spiceCellCtrlsz*sizeof (double);
